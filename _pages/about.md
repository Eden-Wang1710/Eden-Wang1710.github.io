...
My research interests focus on *Large Language Models*, primarily in two areas: trustworthiness (safety, robustness, and interpretability) and applications (including MLLM and agentic reinforcement learning).
